...
//    总结：
//    
//    ReactiveCocoa框架是个重量级框架，学习起来确实比较费时间，学习一个框架，要去了解框架编程思想，
//    比如Masonry框架，采 取的是链式编程，ReactiveCocoa框架，采取的是函数响应式编程。框架固然方便了程序员，
//    但不能太过于去依赖，如果有一天框架没更新了，写的代 码就真的炸了，为此，我不推荐项目迭代时间较久的去使用第三方框架。
